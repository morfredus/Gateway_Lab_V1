...
| v0.0.7 | **Résolution des noms d'hôtes** : mDNS passif + PTR DNS batch ; détection boxes FAI FR (Free/Orange/SFR/Bouygues) ; nouvelle `struct NetworkDevice` (category, model, os, source) ; badges source + modèle dans l'UI |
