...
* Informations réseau
* État de connexion
* Cartouche diagnostics (heap, PSRAM, LittleFS, temps de scan)
...
* Favoris et notes datées par équipement
* Filtres (type, fabricant, favoris uniquement, en ligne uniquement)
* Export de l'inventaire (CSV et/ou JSON) et sauvegarde/restauration des
  paramètres de fonctionnement (réseaux WiFi, luminosité NeoPixel), via le
  menu « Données »
...
* Filtres par type d'événement et par favoris uniquement (équipements actuellement marqués favoris)
...
* Vue simplifiée (texte) de la passerelle/des routeurs détectés et du reste des équipements
* Première étape avant la cartographie graphique du réseau (roadmap v0.4.x : détection des
  répéteurs WiFi, relations entre équipements, visualisation graphique)
